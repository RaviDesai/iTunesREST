...
public struct Content : SerializableToJSON {
    ...
    public func convertToJSON() -> JSONDictionary {
        ...
        dict.addTuplesIfNotNil(
            ...
            (key: "collectionId", value: self.CollectionId),
            (key: "trackId", value: self.TrackId),
            (key: "artistName", value: self.ArtistName),
            (key: "collectionName", value: self.CollectionName),
            (key: "trackName", value: self.TrackName),
            (key: "collectionCensoredName", value: self.CollectionCensoredName),
            (key: "trackCensoredName", value: self.TrackCensoredName),
            (key: "artistViewUrl", value: self.ArtistViewURL.absoluteString),
            (key: "collectionViewUrl", value: self.CollectionViewURL.absoluteString),
            (key: "trackViewUrl", value: self.TrackViewURL.absoluteString),
            (key: "previewUrl", value: self.PreviewURL?.absoluteString),
            (key: "artworkUrl60", value: self.ArtworkURL60?.absoluteString),
            (key: "artworkUrl100", value: self.ArtworkURL100?.absoluteString),
            (key: "collectionPrice", value: self.CollectionPrice),
            (key: "trackPrice", value: self.TrackPrice),
            (key: "collectionExplicitness", value: self.CollectionExplicitness.rawValue),
            (key: "trackExplicitness", value: self.TrackExplicitness.rawValue),
            (key: "discCount", value: self.DiscCount),
            (key: "trackCount", value: self.TrackCount),
            (key: "discNumber", value: self.DiscNumber),
            (key: "trackNumber", value: self.TrackNumber),
            (key: "trackTimeMillis", value: self.TrackTimeMillis),
            (key: "country", value: self.Country),
            (key: "currency", value: self.Currency),
            (key: "primaryGenreName", value: self.PrimaryGenreName),
            (key: "releaseDate", value: toStringFromDate("yyyy-MM-dd'T'HH:mm:ssX", self.ReleaseDate)))
        
        return dict
    }

    public static func createFromJSON(record: JSONDictionary) -> Content? {
